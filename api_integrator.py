...
class WorkingCloudflareAPI:
    ...
    def __init__(self):
        self.technical_email = os.getenv("CLOUDFLARE_EMAIL")
    ...
    def _get_headers(self):
        ...
        elif self.technical_email and self.api_key:
            return {
                "X-Auth-Email": self.technical_email,
...
async def test_fixed_apis():
    ...
    # Test Cloudflare
    print("\n☁️ Testing Fixed Cloudflare API...")
    ...
    # Test OpenProvider
    print("\n🌐 Testing Fixed OpenProvider API...")
    ...
    if cf_success and op_success:
        print("\n✅ BOTH APIS WORKING - Ready to integrate into payment system")
        return True
    else:
        print("\n❌ API issues remain - need credential fixes")
        return False
